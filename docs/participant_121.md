...
``` r
cluster1 <- qm_define("E-3", "F-3", "F-4")
cluster2 <- qm_define("G-3")
cluster3 <- qm_define("G-3", "H-3", "G-4", "H-4")
...
``` r
cluster5 <- qm_define("B-2", "B-3")
cluster6 <- qm_define("B-1", "B-2", "C-1", "C-2")
cluster7 <- qm_define("C-4", "C-5", "D-4", "D-5")
```
