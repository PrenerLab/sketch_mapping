...
``` r
cluster1 <- qm_define("B-2", "B-3", "C-2", "C-3", "D-2", "D-3")
cluster2 <- qm_define("D-2", "E-2", "E-3")
cluster3 <- qm_define("F-3", "G-3")
cluster4 <- qm_define("F-3", "F-6", "G-5", "G-6")
```
...
cluster6 <- qm_define("E-3", "F-3", "G-3")
cluster7 <- qm_define("C-4", "D-4", "C-5", "D-5", "E-5")
cluster8 <- qm_define("F-3", "F-6", "G-5", "G-6")
```
