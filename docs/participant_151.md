...
``` r
cluster1 <- qm_define("C-2", "C-3", "D-2", "D-3")
cluster2 <- qm_define("E-2")
cluster3 <- qm_define("E-2", "E-3")
...
``` r
cluster8 <- qm_define("B-2", "B-3")
cluster9 <- qm_define("B-2", "B-3", "C-2", "C-3")
cluster10 <- qm_define("C-2", "C-3", "D-2", "D-3")
cluster11 <- qm_define("G-6", "G-7", "H-6", "H-7")
```
